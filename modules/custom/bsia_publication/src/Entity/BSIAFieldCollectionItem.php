...
/**
 * @file
 * Definition of \Drupal\bsia_publication\Entity\BSIAFieldCollectionItem.
 */

namespace Drupal\bsia_publication\Entity;
 ...
 * )
 */
class BSIAFieldCollectionItem extends \Drupal\field_collection\Entity\FieldCollectionItem {
	...
	public function label() {
		...
		if (empty($field_label)) {
			...
			return t('Mike was here @label @delta of @host',
